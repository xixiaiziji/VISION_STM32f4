...
/**
  * @brief  Sets the Text Font.设置文本字体
...
/**
  * @brief  Configure the transparency.配置透明度
...
/**
  * @brief  Clears the selected line.清除选定的行
...
/**
  * @brief  Clears the hole LCD.清楚lcd屏
...
/**
  * @brief  Sets the cursor position.设置光标位置
...
/**
  * @brief  Config and Sets the color Keying.配置颜色键控
...
/**
  * @brief  Draws a character on LCD.lcd上绘制字符
...
/**
  * @brief  Displays a rectangle.显示矩形
  * @param  Xpos: specifies the X position, can be a value from 0 to 240.
  * @param  Ypos: specifies the Y position, can be a value from 0 to 320.
...
/**
  * @brief  Draw a full ellipse.画个椭圆
  * @param  Xpos: specifies the X position, can be a value from 0 to 240.
  * @param  Ypos: specifies the Y position, can be a value from 0 to 320.
...
/**
  * @brief  Displays a mono-color picture.显示单色图片
...
/**
  * @brief  Displays an uni-line (between two points).两点划线。
...
/**
  * @brief  Displays an triangle.显示三角形
...
/**
  * @brief  Fill an triangle (between 3 points).三点画三角形
...
/**
  * @brief  Displays an poly-line (between many points).多点多行
  * @param  Points: pointer to the points array.
...
/**
  * @brief  Displays an relative poly-line (between many points).相对多行
  * @param  Points: pointer to the points array.
  * @param  PointCount: Number of points.
