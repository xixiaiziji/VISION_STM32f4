...
void My_DCMI_Init(void)
{
  ...
  DCMI_InitTypeDef DCMI_InitStructure;
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOA|RCC_AHB1Periph_GPIOH|RCC_AHB1Periph_GPIOD|RCC_AHB1Periph_GPIOI|RCC_AHB1Periph_GPIOG, ENABLE);//使能GPIOA B C E G时钟
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5|GPIO_Pin_6|GPIO_Pin_7;// PI6/7/5   复用功能输出
  GPIO_Init(GPIOI, &GPIO_InitStructure);//初始化
	
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3;//PD3 复用功能输出
  GPIO_Init(GPIOD, &GPIO_InitStructure);//初始化	

  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9|GPIO_Pin_10|GPIO_Pin_11|GPIO_Pin_12|GPIO_Pin_14;//PE4/5/6  复用功能输出 
  GPIO_Init(GPIOH, &GPIO_InitStructure);//初始化	
  

	GPIO_PinAFConfig(GPIOA,GPIO_PinSource4,GPIO_AF_DCMI); //PA4,AF13  DCMI_HSYNC
	GPIO_PinAFConfig(GPIOA,GPIO_PinSource6,GPIO_AF_DCMI); //PA6,AF13  DCMI_PCLK  
 	GPIO_PinAFConfig(GPIOI,GPIO_PinSource5,GPIO_AF_DCMI); //PI5,AF13  DCMI_VSYNC 
 	GPIO_PinAFConfig(GPIOH,GPIO_PinSource9,GPIO_AF_DCMI); //PH9,AF13  DCMI_D0  
 	GPIO_PinAFConfig(GPIOH,GPIO_PinSource10,GPIO_AF_DCMI); //PH10,AF13  DCMI_D1 
	GPIO_PinAFConfig(GPIOH,GPIO_PinSource11,GPIO_AF_DCMI); //PH11,AF13  DCMI_D2
	GPIO_PinAFConfig(GPIOH,GPIO_PinSource12,GPIO_AF_DCMI); //PH12,AF13  DCMI_D3
	GPIO_PinAFConfig(GPIOH,GPIO_PinSource14,GPIO_AF_DCMI);//PH14,AF13 DCMI_D4 
	GPIO_PinAFConfig(GPIOD,GPIO_PinSource3,GPIO_AF_DCMI); //PD3,AF13  DCMI_D5 
	GPIO_PinAFConfig(GPIOI,GPIO_PinSource6,GPIO_AF_DCMI); //PI6,AF13  DCMI_D6
	GPIO_PinAFConfig(GPIOI,GPIO_PinSource7,GPIO_AF_DCMI); //PI7,AF13  DCMI_D7
	...
	DCMI_InitStructure.DCMI_CaptureRate=DCMI_CaptureRate_1of4_Frame;//全帧捕获
