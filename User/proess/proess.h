...
#define GETR_FROM_RGB16(RGB565)  ((uint8_t)(((uint16_t)RGB565&0xf800)>>8))		  			//返回8位 R
#define GETG_FROM_RGB16(RGB565)  ((uint8_t)(((uint16_t)RGB565&0x07c0)>>3))	         //返回8位 G
#define GETB_FROM_RGB16(RGB565)  ((uint8_t)(((uint16_t)RGB565&0x001f)<<3))      	//返回8位 B
